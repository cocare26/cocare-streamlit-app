...
<head>
    ...
    <style>
        ...
        .back-icon { position:absolute; left:0; font-size:28px; font-weight:bold; color:#102646; cursor:pointer; }
...
<body>
    <div class="main-wrapper">
        <div class="header-container">
            <div class="back-icon" onclick="go('2_Customer')">‹</div>
        ...
        <div class="bottom-row">
            <div class="bottom-item" onclick="go('9_Report_Problem')"><span>Report Problem</span></div>
            <div class="bottom-item" onclick="go('10_Contact_Us')"><span>Contact Us</span></div>
        </div>
    </div>
    <script>
