...
# =====================================
# CSS المطور (التنسيق وحركات الأيقونات)
# =====================================
st.markdown(f"""
<style>
...
/* --- تعديل: نظام النجوم التفاعلي مع تنسيق الصورة الأصلي --- */
.star-rating {{
    display: flex;
...
.star-rating label {{
    font-size: 35px;
    color: #ddd; /* النجوم الرمادية الافتراضية */
    cursor: pointer;
...
.star-rating label:hover ~ label {{
    color: #ffcc00; /* النجوم الصفراء النشطة */
}}
...
/* حركة الشريط السفلي عند التأشير */
.nav {{
