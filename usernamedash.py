...
# تحميل الصور (تأكدي من وجود الملفات بنفس المجلد)
robot_full = get_base64("robot_full.png")
robot_head = get_base64("robot_head.png")

# =====================================
# CSS المطور (التنسيق، الحركة، وإصلاح العدادات)
# =====================================
st.markdown(f"""
<style>
...
/* تحسين صورة الروبوت - تكبير وإزالة أي تأثير للخلفية */
.robot-img {{
    width: 85px; /* تكبير الحجم */
    height: auto;
    object-fit: contain;
