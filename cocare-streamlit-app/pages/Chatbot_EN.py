...
def get_bot_response(message):
    ...
    elif "renew" in message or "plan" in message or "bundle" in message:
...
# --- CSS Styles (Modified for English LTR) ---
st.markdown(f"""
<style>
...
div[data-testid="stButton"] button {{
    ...
    font-size:12px !important; /* Slightly smaller for English text */
...
.user-row {{
    ...
    flex-direction: row-reverse; /* Flip order for user messages */
}}
...
.bot {{
    background:white;
    color:#111827;
    border-bottom-left-radius:5px; /* Changed for LTR */
    text-align:left;
}}
...
.user {{
    background:#1677e8;
    color:white;
    border-bottom-right-radius:5px; /* Changed for LTR */
    text-align:left;
}}
...
div[data-testid="stFormSubmitButton"] button {{
    ...
    float: right; /* Align button to the right in English context */
}}
</style>
